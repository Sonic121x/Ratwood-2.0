/*
	...
	The canonical calendar system (ES flavor: the Summit Calendar; ported from Azure-Peak's Azurian
	Calendar) is a solar calendar. It is based on the "Grenzelhoftian Calendar", a tennite calendar system.
