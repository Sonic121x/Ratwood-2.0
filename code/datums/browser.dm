...
/datum/browser/modal/alert/New(User,Message,Title,Button1="确定",Button2,Button3,StealFocus = 1,Timeout=6000,Width=350,Height=150)
	if (!User)
		return
...
/proc/askuser(mob/User,Message, Title, Button1="确定", Button2, Button3, StealFocus = 1, Timeout = 6000, Width = 350, Height = 150)
	if (!istype(User))
