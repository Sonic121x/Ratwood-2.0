...
GLOBAL_LIST_INIT(character_flaws, list(
	...
	"破碎心智 (+2 Q-Points)"=/datum/charflaw/mind_broken,
	"视力不佳 (+2 Q-Points)"=/datum/charflaw/badsight,
	"失明 (+2 Q-Points)"=/datum/charflaw/noeyeall,
	"粘人"=/datum/charflaw/clingy,
	"色盲 (+2 Q-Points)"=/datum/charflaw/colorblind,
	"顺从"=/datum/charflaw/compliant,
	"致命脆弱 (+2 Q-Points)"=/datum/charflaw/critweakness,
	"独眼 (左) (+2 Q-Points)"=/datum/charflaw/noeyel,
	"独眼 (右) (+2 Q-Points)"=/datum/charflaw/noeyer,
	"虔诚信徒"=/datum/charflaw/addiction/godfearing,
	"贪婪"=/datum/charflaw/greedy,
	"负债"=/datum/charflaw/indebted,
	"孤僻"=/datum/charflaw/isolationist,
	"咖啡成瘾者"=/datum/charflaw/addiction/caffiend,
	"瘾君子"=/datum/charflaw/addiction/junkie,
	"无法无天"=/datum/charflaw/lawless,
	"巴奥莎之印" =/datum/charflaw/marked_by_baotha,
	"麻风病人 (+2 Q-Points)"=/datum/charflaw/leprosy,
	"绑带松脱"=/datum/charflaw/loose_armor,
	"受虐狂"=/datum/charflaw/addiction/masochist,
	"失鼻"=/datum/charflaw/missing_nose,
	"哑巴 (+2 Q-Points)"=/datum/charflaw/mute,
	"嗜睡症 (+2 Q-Points)"=/datum/charflaw/narcoleptic,
	...
	"失眠 (+2 Q-Points)"=/datum/charflaw/sleepless,
	"烟鬼"=/datum/charflaw/addiction/smoker,
	"言语不通 (+2 Q-Points)"=/datum/charflaw/unintelligible,
	"木臂 (左) (+2 Q-Points)"=/datum/charflaw/limbloss/arm_l,
	"木臂 (右) (+2 Q-Points)"=/datum/charflaw/limbloss/arm_r,
	"噬血者 (+2 Q-Points)"=/datum/charflaw/hemophage,
...
/datum/charflaw/loose_armor
	name = "绑带松脱"
	desc = "我的护甲似乎总也穿不周正。一旦承受过大的压力，它便会糟心地从我身上炸飞出去。"
