...
/datum/outfit/job/roguetown/adventurer/knighte_expert/pre_equip(mob/living/carbon/human/H)
	..()
	var/helmets = list(
		"猪嘴巴斯基奈特盔" 	= /obj/item/clothing/head/roguetown/helmet/bascinet/pigface,
		...
		"面罩沙勒盔"			= /obj/item/clothing/head/roguetown/helmet/sallet/visored,
		"凸鼻面罩沙勒盔"			= /obj/item/clothing/head/roguetown/helmet/sallet/visored/snouted,
		"阿米特盔"				= /obj/item/clothing/head/roguetown/helmet/heavy/knight/armet,
		"凸鼻阿米特盔"				= /obj/item/clothing/head/roguetown/helmet/heavy/knight/armet/snouted,
		"犬面巴斯基奈特盔" 		= /obj/item/clothing/head/roguetown/helmet/bascinet/pigface/hounskull,
