...
/datum/skill/labor/mining
	...
	expert_name = "矿工"
	max_untraited_level = SKILL_LEVEL_APPRENTICE
	trait_uncap = list(TRAIT_LEGENDARY_MINER = SKILL_LEVEL_LEGENDARY,
	TRAIT_HOMESTEAD_EXPERT = SKILL_LEVEL_EXPERT,
	TRAIT_SMITHING_EXPERT = SKILL_LEVEL_EXPERT,
	TRAIT_SELF_SUSTENANCE = SKILL_LEVEL_JOURNEYMAN)
...
/datum/skill/labor/fishing
	...
	dreams = list(
		...
		"……老商人点了点头，递给我一小袋鱼饵：蚯蚓、蛆虫，甚至还有几片奶酪。据说每一样都能为我再带来一份阿比索的恩赐……"
	)
	expert_name = "渔夫"
	max_untraited_level = SKILL_LEVEL_APPRENTICE
	trait_uncap = list(TRAIT_HOMESTEAD_EXPERT = SKILL_LEVEL_LEGENDARY,
