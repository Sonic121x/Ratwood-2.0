...
/obj/item/rogueweapon/katar/punchdagger/frei
	name = "维夫特卡"
	desc = "一种兹瓦尔特基式的冲拳匕首，最初是为在徒手斗殴中与兽人抗衡而设计。它的锯齿边缘与更长、更细的尖锋，都是为了将痛楚最大化，因而得名「开瓶钻」；这一把还带着瑟伦迪尼日纳的旗色。可佩戴在戒指栏位。"
	force = 18
	icon_state = "freiplug"
...
/obj/item/rogueweapon/katar/punchdagger/aav
	name = "阿夫尼克冲拳匕首"
	desc = "一种阿夫尼克式的冲拳匕首，最初是为在徒手斗殴中与兽人抗衡而设计。它的锯齿边缘与更长、更细的尖锋，都是为了将痛楚最大化，因而得名「开瓶钻」；这一把则采用了草原人的旗帜配色。可佩戴在戒指栏位。"
	icon_state = "avplug"
	slot_flags = ITEM_SLOT_RING
