...
/obj/item/rogueweapon/whip/blacksteel
	name = "黑钢鞭"
	desc = "精织丝皮绞成的优雅长鞭，鞭梢嵌以黑钢。用于刑讯太过体面，用于实战又过于奢贵——这般玄妙之物，究竟该当何用？"
	icon_state = "bs_whip"
	force = 25
...
/obj/item/rogueweapon/whip/urumi
	name = "软剑"
	desc = "两段耀眼锋利的钢制刃身自环首护手剑柄旋绕而出。这种介于剑与鞭之间的柔韧兵器，对持握者与目标而言同样危险。"
	icon_state = "urumi"
...
/obj/item/rogueweapon/whip/urumi/iron
	name = "铁软剑"
	desc = "一段耀眼的锋利铁刃自环首护手剑柄旋绕而出。这种介于剑与鞭之间的柔韧兵器，对持握者与目标而言同样危险。"
	icon_state = "i_urumi"
	force = 28
	minstr = 8
	max_integrity = 200
...
/obj/item/rogueweapon/whip/urumi/bronze
	name = "青铜软剑"
	desc = "一段耀眼的青铜刃身从带有指节护手的剑柄向外盘绕而出。这种更沉重、更古老的设计，适合体格更为健壮的战士。"
	icon_state = "b_urumi"
	force = 30
	minstr = 12
...
/obj/item/rogueweapon/whip/urumi/silver
	name = "银软剑"
	desc = "两段银光闪烁的刃身从带有指节护手的剑柄向外盘绕而出。这沉重而宽阔的剑刃要求那些有志于斩除不洁者之人兼具力量与灵巧。"
...
/obj/item/rogueweapon/whip/urumi/blacksteel
	name = "黑钢软剑"
	desc = "两段珍贵的黑钢刃身从精雕细刻的剑柄向外盘绕而出。它既是武器，也是一件艺术品。"
	icon_state = "bs_urumi"
	force = 33
	minstr = 11
	max_integrity = 280
