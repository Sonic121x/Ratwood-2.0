...
/obj/item/clothing/mask/rogue/facemask/steel/steppesman
	name = "草原人战面具"
	desc = "一副钢制面具，被塑造成一张颇具魅力的汉子面孔！高耸的颧骨、挺直的鼻梁，还有一撇醒目的大胡子。不过嘛，阿夫尼克以外的人多半不会觉得戴上它的你有多迷人。"
...
/obj/item/clothing/mask/rogue/spectacles/duelist
	name = "铁制决斗者护目镜"
	desc = "一副为击剑比试而制的硬质防护护目镜，能保护双眼且不遮挡面容。"
	icon_state = "iduelist"
