...
/datum/outfit/job/roguetown/psydoniantemplar/choose_loadout(mob/living/carbon/human/H)
	...
	var/armors = list("审判官 - 锁子甲袍，+2 体质 / +2 意志", "裁决者 - 胸甲，+2 智力 / +2 感知")
	var/armor_choice = input(H, "选择你的护甲。", "披上普赛顿的圣衣。") as anything in armors
	switch(armor_choice)
		if("审判官 - 锁子甲袍，+2 体质 / +2 意志")
	...
	var/weapons = list("普赛顿式长剑 + 盾", "普赛顿式行刑剑 + 盾", "普赛顿式战斧 + 盾", "普赛顿式鞭 + 盾",
		"普赛顿式软剑 + 盾","普赛顿式连枷 + 盾", "普赛顿式巨钉锤 + 短剑", "普赛顿式长矛 + 手锤", "普赛顿式长柄斧 + 短剑",
		"普赛顿式戟 + 短剑", "普赛顿式巨剑 + 手锤")
