...
/datum/advclass/noble/knighte
	...
	extra_context = "该职业无法使用骑术美德。"

	virtue_restrictions = list(
		/datum/virtue/utility/riding
	)
	subclass_stashed_items = list("鞍衣（赛加羚羊）" = /obj/item/caparison, "鞍衣（雾兽）" = /obj/item/caparison/fogbeast)
	extra_context = "该子职业的随身物资中会获得一件鞍衣。根据你的坐骑，选择赛加羚羊版或雾兽版。"
...
/datum/outfit/job/roguetown/adventurer/knighte/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		var/helmets = list(
			...
			"带鼻吻面罩沙勒盔"			= /obj/item/clothing/head/roguetown/helmet/sallet/visored/snouted,
			"阿米特盔"				= /obj/item/clothing/head/roguetown/helmet/heavy/knight/armet,
			"带鼻吻阿米特盔"				= /obj/item/clothing/head/roguetown/helmet/heavy/knight/armet/snouted,
			...
			"带鼻吻圆面护鼻盔"	= /obj/item/clothing/head/roguetown/helmet/bascinet/pigface/roundface/snouted,
