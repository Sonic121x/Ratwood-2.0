...
/datum/status_effect/buff/squire_prox/proc/build_examine_text()
	examine_text = span_slime("<small>SUBJECTPRONOUN 是[owner.mind.knight.real_name]的侍从。</small>")
...
/datum/status_effect/buff/knight_prox/proc/build_examine_text()
	examine_text = span_slime("<small>SUBJECTPRONOUN 是[owner.mind.squire.real_name]的骑士与监护人。</small>")
