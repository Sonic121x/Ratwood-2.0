/datum/job/roguetown/wardenmaster
	...
	tutorial = "你是守林人中最有经验的一位。这些精锐巡游者巡逻、侦察并凶猛守卫着下城区及周边荒野，处理那些城市无暇顾及的威胁与罪行。你的工作是领导这些冷淡的守林人，管束不守规矩的先锋部队，在城墙以南的混乱中开辟秩序。服从低镇男爵的命令，在城墙外执行其意志，作为文明边界之外威胁的第一道防线。确保道路安全，守住先锋堡垒。王权正倚仗着你。"
