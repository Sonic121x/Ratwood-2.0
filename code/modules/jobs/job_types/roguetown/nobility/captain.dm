...
/datum/advclass/captain/infantry
	...
	subclass_stashed_items = list("马衣（赛加羚）" = /obj/item/caparison, "马衣（雾兽）" = /obj/item/caparison/fogbeast)
	extra_context = "该职业在其所选武器上获得大师级技能。该子职业的储物中会获得一件马衣。根据你的坐骑选择赛加羚或雾兽版本。"
