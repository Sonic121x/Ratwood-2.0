// Steward's morning report - ported from Azure-Peak
// (code/modules/roguetown/roguemachine/steward/steward_report.dm). The daily_report_diff
// this reads has been built by SSeconomy since the Economy 3 port; only the printing was
