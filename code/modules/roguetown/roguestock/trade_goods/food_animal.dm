...
/datum/trade_good/animal_fresh/pork
	id = TRADE_GOOD_PORK
	name = "猪肉"
...
/datum/trade_good/animal_fresh/rabbit
...
/datum/trade_good/animal_fresh/egg
	id = TRADE_GOOD_EGG
	name = "蛋"
...
/datum/trade_good/animal_fresh/cheese
...
/datum/trade_good/animal_organic
	category = TRADE_CATEGORY_ANIMAL
	behavior = TRADE_BEHAVIOR_RAW
	display_category = ITEM_CAT_RAW_MATERIAL_ORGANIC

/datum/trade_good/animal_organic/fat
	id = TRADE_GOOD_FAT
	name = "脂肪"
...
/datum/trade_good/animal_organic/tallow
...
/datum/trade_good/animal_preserved
	category = TRADE_CATEGORY_ANIMAL
	behavior = TRADE_BEHAVIOR_RAW
...
/datum/trade_good/animal_preserved/sausage
