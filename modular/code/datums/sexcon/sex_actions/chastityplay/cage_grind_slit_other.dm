...
/datum/sex_action/chastityplay/cage_grind_slit_other/on_start(mob/living/carbon/human/user, mob/living/carbon/human/target)
	user.visible_message(span_warning("[user]向前贴近，直到[user.p_their()][get_chastity_device_name(user)]贴上[target]紧闭的生殖缝。"))
...
/datum/sex_action/chastityplay/cage_grind_slit_other/on_perform(mob/living/carbon/human/user, mob/living/carbon/human/target)
	user.sexcon_action_message(user.sexcon.spanify_force("[user] [user.sexcon.get_generic_force_adjective()]缓慢而不肯停歇地用[user.p_their()][get_chastity_device_name(user)]磨蹭[target]的生殖缝……"))
...
/datum/sex_action/chastityplay/cage_grind_slit_other/on_finish(mob/living/carbon/human/user, mob/living/carbon/human/target)
	user.visible_message(span_warning("[user]向后摇开，让[user.p_their()][get_chastity_device_name(user)]与[target]的生殖缝分离。"))
