...
/datum/particle_weather/rain_gentle
	...
	warning_message = span_greenannounce("灰云在天际缓缓汇聚，仿佛孕育着生命的恩赐。")
	late_warning_message = span_greenannounce("沉重的雨滴开始接连不断地落下。")
...
/datum/particle_weather/rain_storm
	...
	desc = "一场夹带雷鸣的狂暴骤雨。"
	particleEffectType = /particles/weather/rain
	warning_message = span_greenannounce("乌云在天际聚拢，天穹之间不断闪过电光。")
	late_warning_message = span_greenannounce("风向骤变，暴风雨彻底爆发。")
	scale_vol_with_severity = TRUE
...
/datum/particle_weather/hurricane
	...
	desc = "阿比索尔的怒火。"
	particleEffectType = /particles/weather/rain
	warning_message = span_danger("天上的云层黑得如同深夜，拉成长带，远方那道巨大的旋涡几乎超出了肉眼可辨的范围。")
	scale_vol_with_severity = TRUE
