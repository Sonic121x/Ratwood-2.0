...
/datum/particle_weather/snow_gentle
	...
	warning_message = span_greenannounce("寒意在大地间蔓延，温热呼吸旁开始浮现细小白点。")
	late_warning_message = span_greenannounce("雪花在空中盘旋，随后自天际缓缓落下。")
...
/datum/particle_weather/snow_storm
	...
	warning_message = span_greenannounce("厚重云层在天际堆积，寒意席卷大地，温热呼吸边开始浮现细小白点。")
	late_warning_message = span_greenannounce("大片雪花开始迅疾而密集地落下。")
	scale_vol_with_severity = TRUE
	weather_sounds = list(/datum/looping_sound/snow)
